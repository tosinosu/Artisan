...
private const val AD_UNIT_ID = "ca-app-pub-2578519456532696/5352811837"
...
class MyApplication : Application(), Application.ActivityLifecycleCallbacks, LifecycleObserver {
  ...
  private inner class AppOpenAdManager {
    ...
    fun loadAd(context: Context) {
      ...
      AppOpenAd.load(
        context,
        resources.getString(R.string.real_app_open_add_id),
        request,
    ...
    fun showAdIfAvailable(activity: Activity) {
      ...
      try {
        ...
        showAdIfAvailable(
          ...
          object : OnShowAdCompleteListener {
            override fun onShowAdComplete() {
              // Empty because the user will
              // go back to the activity that shows the ad.
            }
          })      }
